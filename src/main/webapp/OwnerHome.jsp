                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="classes-title">
                            ...
                            <h2 class="h2-title">Owner Panel</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="class-box wow fadeInUp" data-wow-delay=".5s" >
                            <a>
                                <div class="class-img" style="height: 250px" >
                                    <img src="images/OwnerDisplayGymPhoto2.jpg" style="height: 250px" alt="Class">
                                </div>
                            </a>
                            <div class="class-box-contant">
                                <div class="class-box-title">
                                    ...
                                    <a href="OwnerManageGyms.jsp"><h3 class="h3-title">Manage<br> Gyms</h3></a>
                                </div>
                                <p>Owner can manage Gyms. Add new Gyms or Remove excisting once.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4"  >
                        <div class="class-box wow fadeInUp" data-wow-delay=".5s" >
                            <a>
                                <div class="class-img" style="height: 250px" >
                                    <img src="images/ManageBookings.png" style="height: 250px" alt="Class">
                                </div>
                            </a>
                            <div class="class-box-contant">
                                <div class="class-box-title">
                                    ...
                                    <a href="OwnerEditGyms.jsp"><h3 class="h3-title">Edit Gyms Infromation</h3></a>
                                </div>
                                <p>Owner can edit its Gym Properties information.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="class-box wow fadeInDown" data-wow-delay=".5s">
                            <div class="class-img" style="height: 250px" >
                                <img src="assets/images/class-img4.jpg" alt="Class" style="height: 250px" >
                            </div>
                            <div class="class-box-contant">
                                <div class="class-box-title">
                                    <div class="class-box-icon">
